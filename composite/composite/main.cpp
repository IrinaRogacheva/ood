...
int main()
{
	try
	{
		...
		auto mouseHead = std::make_shared<CGroup>();
		...
		auto mouse = std::make_shared<CGroup>();
		...
		std::cout << frame.left << " " << frame.top << " " << frame.width << " " << frame.height << std::endl;
